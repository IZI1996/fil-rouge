        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
          ...
          <li class="nav-item nav-profile dropdown">
              ...
              <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                <a class="dropdown-item" href="coureses.php">
...
<?php
//------------------------------Card------------------------//
          $query="SELECT * FROM users,courses inner JOIN catg_specialty on catg_specialty.Catg_id=courses.idsplt
...
<form method="post">
  <div class="col">
    <div class="card h-100"   style="background-color:white;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
      <img
        src="../../<?php echo $row['imgcour']?>
"
        class="card-img-top"
        alt="..."
      />
      <div class="card-body">
        <h5 name="nomcour" class="card-title"><?php echo $row['namecour']?></h5>
        <p name="dis" class="card-text d-flex align-items-center">
...
$nomcour=$row['namecour'];
$discription=$row['description'];
                                                
$query= "INSERT INTO archivecours(NameCours,discriptioncour) 
                    VALUES('$nomcour','$discription')";
